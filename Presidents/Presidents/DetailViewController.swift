...
class DetailViewController: UIViewController,UIPopoverControllerDelegate {
    ...
    private func modifyUrlForLanguage(#url: String, language lang: String?) -> String {
        ...
        //We´re relying on a particular Wikipedia Url formar here. this
        //is a bit fragile!
        if let langStr =  lang {
    ...
    func toggleLanguagePopover() {
        if languagePopoverController == nil {
            ...
            languagePopoverController?.presentPopoverFromBarButtonItem(languageButton!, permittedArrowDirections: UIPopoverArrowDirection.Any, animated: true)
        }else{
