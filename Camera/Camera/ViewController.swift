...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    var image:UIImage?
    var movieURL:NSURL?
    var lastChosenMediaType:NSString?
    ...
    func setMoviePlayerLayoutConstraints1() {
        let moviePlayerView = moviePlayerController!.view
        moviePlayerView.setTranslatesAutoresizingMaskIntoConstraints(false)
        let views = ["moviePlayerView":moviePlayerView,"takenPictureButton":takePictureButton]
        ...
        view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:[moviePlayerView]-0-[takenPictureButton]", options: NSLayoutFormatOptions(0), metrics: nil, views: views))
    }
    ...
    func setMoviePlayerLayoutConstraints() {
        ...
        view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat(
            "H:|[moviePlayerView]|", options:NSLayoutFormatOptions(0), metrics:nil, views:views))
        view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat(
            "V:|[moviePlayerView]-0-[takePictureButton]", options:NSLayoutFormatOptions(0),
